                    ...
                    <form action="{{ route('utilisateurs.store') }}" method="POST" class="form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control border-primary" id="firstname" type="text" name="firstname">
                            </div>
                            <div class="form-group">
                                <label for="price">LastName</label>
                                <input class="form-control border-primary" type="text" id="lastname" name="lastname">
                            </div>
                            <div class="form-group">
                                <label for="quantity">Email</label>
                                <input class="form-control border-primary" type="email" id="email" name="email">
                            </div>
